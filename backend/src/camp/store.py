...
from .models import (Batch, FeedbackEvent, LunchGroup, MenuItem, OnboardingProfile, Order, RampAttempt,
...
TABLES: dict[type[BaseModel], str] = {
    ...
    SyncState: "sync", ScheduledOrder: "schedules", OnboardingProfile: "onboarding",
}
...
INDEXED: dict[str, list[str]] = {
    ...
    "groups": ["office_id", "date"], "ramp_attempts": [], "ramp_overages": ["ramp_user_id"], "sync": [],
    "schedules": ["user_id"], "onboarding": ["office_id"],
}
